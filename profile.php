...
<html lang="en">
  ...
  <div class="form-group">
    ...
    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="photo">
                        ...
                        <h3><span class="badge badge-info">Contact Information</span> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addLocationModal">New Location</button></h3>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      ...
      <label for="inputZip">Education Level</label>
        <select type="text" class="form-control" id="inputEducation" name="education">
            <option>None</option>
      ...
      <input type="text" class="form-control" id="inputOccupation" name="occupation">
            ...
            <span class="badge badge-primary">Original Location</span>
            <div class = "row">
                <div class="form-group col-md-8">
    <label for="inputAddress">Address</label>
  ...
  <div class="form-group col">
    <label for="inputAddress2">Unit Number</label>
    <input type="text" class="form-control" id="inputAddress2" placeholder="Unit 203" name="address2Origin">
  </div>
            </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      <label for="inputZip">Postal Code</label>
      <input type="text" class="form-control" id="inputZip" name="postalCodeOrigin">
      </div>
      <div class="form-group col-md-3">
    ...
    <textarea class="form-control" id="inputNeeds1" rows="3" name="special_needs"></textarea>
           ...
           <!-- Modal -->
    <div class="modal fade bd-example-modal-lg" id="addLocationModal" tabindex="-1" role="dialog" aria-labelledby="addLocationModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="addLocationModalLabel">New Location</h5>
